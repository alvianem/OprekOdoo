...
class TechTech(models.Model):
    ...
    competency_tech_types = fields.Many2one(related='competency_tech.types')
    category_competency_tech = fields.Many2one('comp.tech.category')
    competency_tech = fields.Many2one('comp.tech')
...
class CompetencyTech(models.Model):
    ...
    name = fields.Char()
    types = fields.Many2one('comp.tech.types')
# ------------------------------------------------------------------------------------------
...
class NontechNontech(models.Model):
    ...
    category_competency_nontech = fields.Many2one('comp.nontech.category')
...
# class tes(models.Model):
    ...
    # tes1 = fields.One2many('nontech.nontech','tes2')
